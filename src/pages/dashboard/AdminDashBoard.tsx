    ...
    <div className="container mx-auto p-6 space-y-8">
          ...
          {data.patients.map((patient) => (
            ...
            >
              ...
              <button
                ...
                onClick={() => router.replace("/dashboard/createDietChart")}
              >
                Add Diet Chart
              </button>
            </div>
          ...
          {data.staff.map((staff) => (
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                ...
                {[
                  staff.isAdmin && "Admin",
                  staff.isPantry && "Pantry",
                  staff.isDelivery && "Delivery",
                ]
                  .filter(Boolean)
                  .join(", ")}
              </p>
      ...
      <div className="flex flex-wrap gap-4">
        {data.tasks.map((task) => (
          <div
            key={task._id}
            className="w-[350px] bg-white rounded-lg shadow-md p-4 hover:shadow-lg"
          >
